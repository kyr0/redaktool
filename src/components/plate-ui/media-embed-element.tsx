  ...
  withRef<typeof PlateElement>(({ children, className, ...props }, ref) => {
    ...
    return (
      <MediaPopover pluginKey={ELEMENT_MEDIA_EMBED}>
        <PlateElement
          className={cn('ab-relative ab-py-2.5', className)}
          ref={ref}
          {...props}
        >
          <figure className='ab-group ab-relative ab-m-0 ab-w-full' contentEditable={false}>
            <Resizable
              align={align}
              options={{
                align,
            ...
            >
              ...
              {isVideo ? (
                isYoutube ? (
                  ...
                  <div
                    className={cn(
                      provider === 'vimeo' && 'ab-pb-[75%]',
                      provider === 'youku' && 'ab-pb-[56.25%]',
                      provider === 'dailymotion' && 'ab-pb-[56.0417%]',
                      provider === 'coub' && 'ab-pb-[51.25%]'
                    )}
                  >
                    <iframe
                      allowFullScreen
                      className={cn(
                        'ab-absolute ab-left-0 ab-top-0 ab-size-full ab-rounded-sm',
                        isVideo && 'ab-border-0',
                        focused && selected && 'ab-ring-2 ab-ring-ring ab-ring-offset-2'
                      )}
                      src={embed!.url}
                      title="embed"
                    />
              ...
              {isTweet && (
                <div
                  className={cn(
                    '[&_.react-tweet-theme]:ab-my-0',
                    !readOnly &&
                      selected &&
                      '[&_.react-tweet-theme]:ab-ring-2 [&_.react-tweet-theme]:ab-ring-ring [&_.react-tweet-theme]:ab-ring-offset-2'
                  )}
                >
                  <Tweet id={embed!.id!} />
                </div>
