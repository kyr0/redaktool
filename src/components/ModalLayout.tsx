import { CalendarIcon, CogIcon, EditIcon, LibraryIcon, Mic2Icon, MicIcon, RadarIcon } from "lucide-react"
...
export type ModuleNames = "scratchpad" | "archive" | "settings" | "transcription" | "radar"
            ...
            <ResizablePanel defaultSize={20} minSize={15}>
                <div className="ab-flex ab-ab-h-fit ab-items-center ab-justify-center ab-p-0">
                    <Command>
                        <CommandList>
                            <CommandGroup>
                                <CommandItem value="scratchpad" onSelect={onCommandSelect} className={activeModule === 'scratchpad' ? `ab-ftr-active-menu-item` : 'ab-ftr-menu-item'}>
                                    <EditIcon className="ab-mr-2 ab-h-4 ab-w-4 ab-shrink-0" />
                                    <span>ScratchPad</span>
                                    <CommandShortcut>⌃S</CommandShortcut>
                                </CommandItem>
                                <CommandItem value="radar" onSelect={onCommandSelect} className={activeModule === 'radar' ? `ab-ftr-active-menu-item` : 'ab-ftr-menu-item'}>
                                    <RadarIcon className="ab-mr-2 ab-h-4 ab-w-4 ab-shrink-0" />
                                    <span>NewsRadar</span>
                                    <CommandShortcut>⌃R</CommandShortcut>
                                </CommandItem>
                                <CommandItem value="archive" onSelect={onCommandSelect} className={activeModule === 'archive' ? `ab-ftr-active-menu-item` : 'ab-ftr-menu-item'}>
                            ...
                            <CommandItem value="transcription" onSelect={onCommandSelect} className={activeModule === 'transcription' ? `ab-ftr-active-menu-item` : 'ab-ftr-menu-item'}>
                            ...
                            <CommandGroup>
                                <CommandItem value="settings" onSelect={onCommandSelect} className={activeModule === 'settings' ? `ab-ftr-active-menu-item` : 'ab-ftr-menu-item'}>
