...
import { promptTemplateProofreading } from "../../../data/prompt-templates/proofreading";

const editorAtom = atom<string>("");

const ProofreadingPromptValuesSchema = z.object({
  AUDIENCE: z.string(),
  FORMAT: z.string(),
  TONE: z.string(),
...
export const ProofreadingModule = () => {
  ...
  const form = useForm<z.infer<typeof ProofreadingPromptValuesSchema>>({
    resolver: zodResolver(ProofreadingPromptValuesSchema),
    defaultValues: {
  ...
  return (
    <GenericModule
      ...
      defaultPromptTemplate={promptTemplateProofreading}
