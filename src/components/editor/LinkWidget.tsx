  ...
  return (
    <>
      ...
      <span>
        ...
        {
          <>
            <small className="ab-font-mono ab-font-semibold">
              <LinkIcon className="ab-w-4 ab-h-4 ab-inline-block" />{" "}
            </small>
            <input
              size={href.length}
              placeholder="link"
              ...
              className={`ab-rounded ab-border-none ab-py-0 ab-px-2 ab-ring-1 ab-max-w-96 ${`ab-w-[${
                href.length * 0.5
              }rem]`}`}
              type="text"
              defaultValue={href}
            ...
            &nbsp;
            <small className="ab-font-mono ab-font-semibold">
              <TagIcon className="ab-w-4 ab-h-4 ab-inline-block" />{" "}
            </small>
            <input
              size={title.length || 5}
              placeholder="title"
              ...
              className="ab-rounded ab-border-none ab-py-0 ab-px-2 ab-ring-1  ab-max-w-52"
              type="text"
              defaultValue={title}
            />
          </>
