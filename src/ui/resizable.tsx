...
const ResizableHandle = ({
  ...
  <ResizablePrimitive.PanelResizeHandle
    className={cn(
      `ab-relative ab-flex ab-w-px ab-items-center ab-justify-center ab-bg-border after:ab-absolute after:ab-inset-y-0 after:ab-left-1/2 after:ab-w-1 after:-ab-translate-x-1/2 focus-visible:ab-outline-none focus-visible:ab-ring-1 focus-visible:ab-ring-ring focus-visible:ab-ring-offset-1 data-[panel-group-direction=vertical]:ab-h-px data-[panel-group-direction=vertical]:ab-w-full data-[panel-group-direction=vertical]:after:ab-left-0 data-[panel-group-direction=vertical]:after:ab-h-1 data-[panel-group-direction=vertical]:after:ab-w-full data-[panel-group-direction=vertical]:after:-ab-translate-y-1/2 data-[panel-group-direction=vertical]:after:ab-translate-x-0 [&[data-panel-group-direction=vertical]>div]:ab-rotate-90  ${
        direction === "vertical" ? "ab-w-[100%] ab-h-[1px]" : ""
      }`,
      className,
    )}
    {...props}
  >
    {withHandle && (
      <div
        className={`ab-z-10 ab-flex ab-h-4 ab-w-3 ab-items-center ab-justify-center ab-rounded-sm ab-border ab-bg-border ${
          direction === "vertical" ? "ab-rotate-90" : ""
        }`}
      >
