...
export class PreTrainedTokenizer extends PreTrainedTokenizer_base {
     ...
     */
    apply_chat_template(conversation: Message[], { chat_template, add_generation_prompt, tokenize, padding, truncation, max_length, return_tensor, return_dict, tokenizer_kwargs, ...kwargs }?: {
