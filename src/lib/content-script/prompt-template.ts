...
export const applyTemplateValues = (promptTemplate: string, values: Record<string, string>) => {
...
export const generatePrompt = (promptName: PromptNames, values: TranslatePromptValues): Prompt => {
