...
import { getSelectionStore, selectionAtom, selectionGuaranteedAtom, type TrackedSelection } from "../stores/use-selection";
...
export const useSelection = (onSelectionChanged: (selection: TrackedSelection | null) => void = () => {}) => {
    ...
    useEffect(() => {
        ...
        return () => {
            document.removeEventListener('selectionchange', trackSelectionChange, false);
        };
    }, [])
