...
export function selectEditorContent(editorName: string) {
    ...
    const editableElement = document.querySelector(`[data-editor-name='${editorName}'] [contenteditable=true]`)! as HTMLElement;
...
export function restorePreviousSelection(prevSelectionDetails?: SelectionDetails | null) {
